    ...
    alert("ready");
      ...
      $.ajax(settings).done(function (response) {
        ...
        for (var i = 0; i < response.length; i++) {
          ...
          html += "<td class='nombre-col'>"+nombre+"</td><td class='nss-col'>"+ssn+"</td><td class='poliza-col'>"+poliza+"</td><td class='act1-col'><a href='#'class='btn btn-outline-primary' role='button'>Ver Reporte</a></td><td class='act2-col'><a onclick='modify("+ssn+")' href='#'class='btn btn-outline-secondary' role='button'>Modificar Status</a></td>";
          html += "</tr>";
        }
